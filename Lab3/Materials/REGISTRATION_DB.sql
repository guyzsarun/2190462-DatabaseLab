...
cid`,
`sect_id
`, `semester`, `year`, `building`, `room`, `timeslot_id`) VALUES
...
student_id`,
`cid
`, `sect_id`, `semester`, `year`, `grade`) VALUES
...
ALTER TABLE `Teaches`
ADD PRIMARY KEY
(`pid`,`cid`,`sect_id`,`semester`,`year`),
ADD KEY `teaches_ibfk_2`
(`cid`,`sect_id`,`semester`,`year`);
...
--
ALTER TABLE `Takes`
ADD CONSTRAINT `takes_ibfk_1` FOREIGN KEY
(`student_id`) REFERENCES `Student`
(`student_id`),
ADD CONSTRAINT `takes_ibfk_2` FOREIGN KEY
(`cid`,`sect_id`,`semester`,`year`) REFERENCES `Section`
(`cid`, `sect_id`, `semester`, `year`);
...
--
ALTER TABLE `Teaches`
ADD CONSTRAINT `teaches_ibfk_1` FOREIGN KEY
(`pid`) REFERENCES `Professor`
(`pid`),
ADD CONSTRAINT `teaches_ibfk_2` FOREIGN KEY
(`cid`,`sect_id`,`semester`,`year`) REFERENCES `Section`
(`cid`, `sect_id`, `semester`, `year`);
COMMIT;
